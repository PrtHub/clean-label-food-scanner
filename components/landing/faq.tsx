      ...
      <div className="max-w-4xl mx-auto px-6 relative">
        <AnimateIn className="text-center mb-20">
          ...
          <h2 className="text-4xl sm:text-5xl font-bold text-white tracking-tight mb-5 underline decoration-emerald-500/30 underline-offset-8">
            Got Questions?{" "}
            <span className="text-zinc-500">We have answers.</span>
          </h2>
        </AnimateIn>
        ...
        <div className="space-y-4">
          {FAQ_ITEMS.map((item, i) => (
            <AnimateIn key={i} delay={i * 50}>
              <details className="group relative rounded-3xl bg-[rgb(255 255 255 / 0.03)] border border-white/5 overflow-hidden transition-all duration-300 open:border-emerald-500/30 open:bg-linear-to-b open:from-[rgb(255 255 255 / 0.03)] open:to-emerald-500/5 hover:border-white/10">
                <summary className="flex items-center justify-between cursor-pointer px-8 py-7 text-left list-none outline-none">
                  ...
                  <div className="relative w-6 h-6 shrink-0">
                    <Plus className="absolute inset-0 w-6 h-6 text-zinc-500 transition-transform duration-300 group-open:rotate-90 group-open:opacity-0" />
        ...
        <AnimateIn delay={400} className="mt-20 text-center">
          <div className="inline-block p-1 rounded-2xl bg-linear-to-r from-emerald-500/20 via-white/5 to-emerald-500/20">
            <div className="bg-[rgb(255 255 255 / 0.03)] rounded-xl px-8 py-6 border border-white/5">
